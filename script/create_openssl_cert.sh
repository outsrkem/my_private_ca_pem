...
(umask 077; openssl genrsa -out $SERVER_CERT_KEY 2048)
openssl req -new \
...
# 创建服务器(Nginx)证书证书链
cat server.crt intermediate_ca.crt ca.crt > server_chain.crt
